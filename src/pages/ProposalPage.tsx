...
import { ProposalList, ProposalForm, ProposalStats } from '../modules/proposal/components';
import type { Proposal } from '../modules/proposal/types/proposal.types';
  ...
  return (
    <div className="proposal-page">
      ...
      <ProposalList
        onAdd={handleAdd}
        onEdit={handleEdit}
        onView={(item) => console.log('View Proposal:', item)}
