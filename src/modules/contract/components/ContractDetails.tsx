...
export const ContractDetailsPage: React.FC<ContractDetailsPageProps> = ({ onEdit, onDelete }) => {
  ...
  // ✅ استفاده از useItemWithPayments
  const { useItemWithPayments, delete: deleteContract, isDeleting } = useContract();
  
  const { data: contractData, isLoading, refetch } = useItemWithPayments(Number(id));
  ...
  const financialProgress = totalAmount > 0 
    ? Math.round((paidAmount / totalAmount) * 100) 
    : 0;
  const physicalProgress = contract?.physical_progress || 0;
...
<div class="container">
  ...
  <div class="cards">
    <div class="card blue"><div class="lbl">مبلغ کل</div><div class="val">${toPersianNumberFn(Number(totalAmount))} ریال</div></div>
    <div class="card green"><div class="lbl">مبلغ پرداختی</div><div class="val">${toPersianNumberFn(Number(paidAmount))} ریال</div></div>
    <div class="card ${remaining > 0 ? 'red' : 'green'}"><div class="lbl">مبلغ باقیمانده</div><div class="val">${toPersianNumberFn(Number(remaining))} ریال</div></div>
    <div class="card orange"><div class="lbl">پیشرفت مالی</div><div class="val">${toPersianNumberFn(financialProgress)}%</div></div>
    <div class="card purple"><div class="lbl">پیشرفت فیزیکی</div><div class="val">${toPersianNumberFn(physicalProgress)}%</div></div>
  </div>
  <div class="progress-section">
    <div class="progress-item">
      <div class="head"><span>پیشرفت مالی</span><span>${toPersianNumberFn(financialProgress)}%</span></div>
      <div class="bar"><div class="fill financial" style="width:${financialProgress}%;"></div></div>
    </div>
    <div class="progress-item">
      <div class="head"><span>پیشرفت فیزیکی</span><span>${toPersianNumberFn(physicalProgress)}%</span></div>
      <div class="bar"><div class="fill physical" style="width:${physicalProgress}%;"></div></div>
    </div>
  </div>
  <div class="grid">
    <div>
      <div class="section"><h3>🏢 طرف قرارداد</h3>
      ...
      <div class="section"><h3>📅 تاریخ‌ها</h3>
        ...
        <div class="row"><span class="lbl">مدت قرارداد</span><span class="val highlight">${toPersianNumberFn(contract.contract_duration_months || 0)} ماه</span></div>
      </div>
      <div class="section"><h3>💰 اطلاعات مالی</h3>
        <div class="row"><span class="lbl">مبلغ کل</span><span class="val highlight">${toPersianNumberFn(Number(totalAmount))} ریال</span></div>
        <div class="row"><span class="lbl">مبلغ پرداختی</span><span class="val" style="color:#059669;">${toPersianNumberFn(Number(paidAmount))} ریال</span></div>
        <div class="row"><span class="lbl">مبلغ باقیمانده</span><span class="val" style="color:${remaining > 0 ? '#d97706' : '#059669'};">${toPersianNumberFn(Number(remaining))} ریال</span></div>
      </div>
    </div>
    <div>
      ...
      <div class="section meta-section"><h3>📋 اطلاعات تکمیلی</h3>
        <div class="row"><span class="lbl">شناسه</span><span class="val">#${toPersianNumberFn(contract.id)}</span></div>
        <div class="row"><span class="lbl">نسخه</span><span class="val">${toPersianNumberFn(contract.version)}</span></div>
  ...
  const exportCSV = () => {
    ...
    try {
      const rows = [
        ...
        ['مبلغ کل', toPersianNumberFn(Number(totalAmount))],
        ['مبلغ پرداختی', toPersianNumberFn(Number(paidAmount))],
        ['مبلغ باقیمانده', toPersianNumberFn(Number(remaining))],
        ['پیشرفت مالی', toPersianNumberFn(financialProgress)],
        ['پیشرفت فیزیکی', toPersianNumberFn(physicalProgress)],
        ...
        ['مدت (ماه)', toPersianNumberFn(contract.contract_duration_months || 0)],
        ['نسخه', toPersianNumberFn(contract.version)],
...
مبلغ کل: ${toPersianNumberFn(Number(totalAmount))} ریال
مبلغ پرداختی: ${toPersianNumberFn(Number(paidAmount))} ریال
مبلغ باقیمانده: ${toPersianNumberFn(Number(remaining))} ریال
پیشرفت مالی: ${toPersianNumberFn(financialProgress)}%
پیشرفت فیزیکی: ${toPersianNumberFn(physicalProgress)}%
...
تاریخ شروع: ${contract.start_date}
تاریخ پایان: ${contract.end_date}
مدت قرارداد: ${toPersianNumberFn(contract.contract_duration_months || 0)} ماه

───────────────────────────────────────────────────────────
                    اطلاعات تکمیلی
───────────────────────────────────────────────────────────

شناسه: #${toPersianNumberFn(contract.id)}
بایگانی: ${contract.is_archived ? 'بله' : 'خیر'}
...
<body>
  ...
  <div class="cards">
    <div class="card" style="background:#eef2ff;"><div class="lbl">مبلغ کل</div><div class="val" style="color:#4f46e5;">${toPersianNumberFn(Number(totalAmount))} ریال</div></div>
    <div class="card" style="background:#d1fae5;"><div class="lbl">مبلغ پرداختی</div><div class="val" style="color:#059669;">${toPersianNumberFn(Number(paidAmount))} ریال</div></div>
    <div class="card" style="background:${remaining > 0 ? '#fee2e2' : '#d1fae5'};"><div class="lbl">مبلغ باقیمانده</div><div class="val" style="color:${remaining > 0 ? '#dc2626' : '#059669'};">${toPersianNumberFn(Number(remaining))} ریال</div></div>
    <div class="card" style="background:#fef3c7;"><div class="lbl">پیشرفت مالی</div><div class="val" style="color:#d97706;">${toPersianNumberFn(financialProgress)}%</div></div>
    <div class="card" style="background:#dbeafe;"><div class="lbl">پیشرفت فیزیکی</div><div class="val" style="color:#6366f1;">${toPersianNumberFn(physicalProgress)}%</div></div>
  </div>
  <div class="progress-section">
    <div class="progress-item">
      <div class="head"><span>پیشرفت مالی</span><span class="value">${toPersianNumberFn(financialProgress)}%</span></div>
      <div class="bar"><div class="fill financial" style="width:${financialProgress}%;"></div></div>
    </div>
    <div class="progress-item">
      <div class="head"><span>پیشرفت فیزیکی</span><span class="value">${toPersianNumberFn(physicalProgress)}%</span></div>
      <div class="bar"><div class="fill physical" style="width:${physicalProgress}%;"></div></div>
    </div>
  </div>
  <div class="grid">
    <div>
      ...
      <div class="section"><h3>اطلاعات مالی</h3>
        <div class="row"><span class="lbl">مبلغ کل</span><span class="val highlight">${toPersianNumberFn(Number(totalAmount))} ریال</span></div>
        <div class="row"><span class="lbl">مبلغ پرداختی</span><span class="val success">${toPersianNumberFn(Number(paidAmount))} ریال</span></div>
        <div class="row"><span class="lbl">مبلغ باقیمانده</span><span class="val ${remaining > 0 ? 'warning' : 'success'}">${toPersianNumberFn(Number(remaining))} ریال</span></div>
      </div>
    </div>
    <div>
      ${contract.commitments ? `<div class="section"><h3>تعهدات طرفین</h3><div class="desc">${contract.commitments}</div></div>` : ''}
        ...
        <div style="padding: 25px 30px; background: white; font-family: 'Vazir', 'B Nazanin', Tahoma, sans-serif; direction: rtl; max-width: 794px;">
          ...
          <div style="display: grid; grid-template-columns: repeat(5, 1fr); gap: 8px; margin-bottom: 16px;">
            <div style="background: #eef2ff; border-radius: 8px; padding: 10px 12px; text-align: center;">
              ...
              <div style="font-size: 13px; font-weight: 700; color: #4f46e5;">${toPersianNumberFn(Number(totalAmount))} ریال</div>
            </div>
            <div style="background: #d1fae5; border-radius: 8px; padding: 10px 12px; text-align: center;">
              ...
              <div style="font-size: 13px; font-weight: 700; color: #059669;">${toPersianNumberFn(Number(paidAmount))} ریال</div>
            </div>
            <div style="background: ${remaining > 0 ? '#fee2e2' : '#d1fae5'}; border-radius: 8px; padding: 10px 12px; text-align: center;">
              ...
              <div style="font-size: 13px; font-weight: 700; color: ${remaining > 0 ? '#dc2626' : '#059669'};">${toPersianNumberFn(Number(remaining))} ریال</div>
            </div>
            <div style="background: #fef3c7; border-radius: 8px; padding: 10px 12px; text-align: center;">
              ...
              <div style="font-size: 13px; font-weight: 700; color: #d97706;">${toPersianNumberFn(financialProgress)}%</div>
            </div>
            <div style="background: #dbeafe; border-radius: 8px; padding: 10px 12px; text-align: center;">
              ...
              <div style="font-size: 13px; font-weight: 700; color: #6366f1;">${toPersianNumberFn(physicalProgress)}%</div>
            </div>
          </div>
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 16px; padding: 12px 16px; background: #f8fafc; border-radius: 8px; border: 1px solid #e9ecef;">
            <div>
              <div style="display: flex; justify-content: space-between; font-size: 11px; color: #374151; margin-bottom: 3px;">
                ...
                <span style="font-weight: 600; color: #1a1a2e;">${toPersianNumberFn(financialProgress)}%</span>
              </div>
            ...
            <div>
              <div style="display: flex; justify-content: space-between; font-size: 11px; color: #374151; margin-bottom: 3px;">
                ...
                <span style="font-weight: 600; color: #1a1a2e;">${toPersianNumberFn(physicalProgress)}%</span>
              </div>
              <div style="height: 6px; background: #e9ecef; border-radius: 3px; overflow: hidden;">
            ...
            <div>
              ...
              <div style="background: #f8fafc; border: 1px solid #e9ecef; border-radius: 8px; padding: 12px 14px; margin-bottom: 12px;">
                ...
                <div style="display: flex; justify-content: space-between; padding: 3px 0; font-size: 11px;">
                  ...
                  <span style="font-weight: 600; color: #4f46e5;">${toPersianNumberFn(contract.contract_duration_months || 0)} ماه</span>
                </div>
              </div>
              <div style="background: #f8fafc; border: 1px solid #e9ecef; border-radius: 8px; padding: 12px 14px;">
                ...
                <div style="display: flex; justify-content: space-between; padding: 3px 0; border-bottom: 1px solid #f3f4f6; font-size: 11px;">
                  ...
                  <span style="font-weight: 700; color: #4f46e5;">${toPersianNumberFn(Number(totalAmount))} ریال</span>
                </div>
                <div style="display: flex; justify-content: space-between; padding: 3px 0; border-bottom: 1px solid #f3f4f6; font-size: 11px;">
                  <span style="color: #6b7280;">مبلغ پرداختی</span>
                  <span style="font-weight: 700; color: #059669;">${toPersianNumberFn(Number(paidAmount))} ریال</span>
                </div>
                <div style="display: flex; justify-content: space-between; padding: 3px 0; font-size: 11px;">
                  <span style="color: #6b7280;">مبلغ باقیمانده</span>
                  <span style="font-weight: 700; color: ${remaining > 0 ? '#d97706' : '#059669'};">${toPersianNumberFn(Number(remaining))} ریال</span>
                </div>
              </div>
            </div>
            <div>
              ...
              <div style="background: #f8fafc; border: 1px solid #e9ecef; border-radius: 8px; padding: 12px 14px; margin-top: 12px;">
                ...
                <div style="display: flex; justify-content: space-between; padding: 2px 0; font-size: 10px; border-bottom: 1px solid #f3f4f6;">
                  ...
                  <span style="font-weight: 500;">#${toPersianNumberFn(contract.id)}</span>
                </div>
                <div style="display: flex; justify-content: space-between; padding: 2px 0; font-size: 10px; border-bottom: 1px solid #f3f4f6;">
                  <span style="color: #6b7280;">نسخه</span>
                  <span style="font-weight: 500;">${toPersianNumberFn(contract.version)}</span>
                </div>
                <div style="display: flex; justify-content: space-between; padding: 2px 0; font-size: 10px; border-bottom: 1px solid #f3f4f6;">
      ...
      const data = [
        {
          ...
          'طرف قرارداد': contract.company_name || contract.university_name || '—',
          'نوع همکار': contract.affiliation_type === 'UNIVERSITY' ? 'دانشگاه' : 'شرکت',
          'مبلغ کل (ریال)': toPersianNumberFn(Number(totalAmount)),
          'مبلغ پرداختی (ریال)': toPersianNumberFn(Number(paidAmount)),
          'مبلغ باقیمانده (ریال)': toPersianNumberFn(Number(remaining)),
          'پیشرفت مالی (%)': toPersianNumberFn(financialProgress),
          'پیشرفت فیزیکی (%)': toPersianNumberFn(physicalProgress),
          'وضعیت': CONTRACT_STATUSES[contract.status]?.label || contract.status,
          'تاریخ قرارداد': contract.date,
...
<contract>
  <header>
    ...
    <version>${toPersianNumberFn(contract.version)}</version>
  </header>
  
  <financial>
    <total_amount>${toPersianNumberFn(Number(totalAmount))}</total_amount>
    <paid_amount>${toPersianNumberFn(Number(paidAmount))}</paid_amount>
    <remaining_amount>${toPersianNumberFn(Number(remaining))}</remaining_amount>
    <financial_progress>${toPersianNumberFn(financialProgress)}</financial_progress>
    <physical_progress>${toPersianNumberFn(physicalProgress)}</physical_progress>
  </financial>
  ...
  <dates>
    ...
    <duration_months>${toPersianNumberFn(contract.contract_duration_months || 0)}</duration_months>
  </dates>
  
  <details>
    <id>${toPersianNumberFn(contract.id)}</id>
  ...
  return (
    <div className="contract-details-page" ref={contentRef}>
      {/* Header */}
      ...
      <div className="details-content">
        <div className="summary-cards">
          <div className="summary-card">
            ...
            <div className="summary-info">
              ...
              <span className="summary-value">{toPersianNumberFn(Number(totalAmount))} ریال</span>
            </div>
          </div>
          <div className="summary-card">
            ...
            <div className="summary-info">
              ...
              <span className="summary-value">{toPersianNumberFn(Number(paidAmount))} ریال</span>
            </div>
          </div>
          <div className="summary-card">
            ...
            <div className="summary-info">
              ...
              <span className="summary-value">{toPersianNumberFn(Number(remaining))} ریال</span>
            </div>
          </div>
          <div className="summary-card">
            ...
            <div className="summary-info">
              ...
              <span className="summary-value">{toPersianNumberFn(financialProgress)}%</span>
            </div>
          </div>
          <div className="summary-card">
            ...
            <div className="summary-info">
              ...
              <span className="summary-value">{toPersianNumberFn(physicalProgress)}%</span>
            </div>
          </div>
        </div>
        ...
        <div className="progress-section">
          <div className="progress-item">
            <div className="progress-header">
              ...
              <span className="progress-value">{toPersianNumberFn(financialProgress)}%</span>
            </div>
          ...
          <div className="progress-item">
            <div className="progress-header">
              ...
              <span className="progress-value">{toPersianNumberFn(physicalProgress)}%</span>
            </div>
            <div className="progress-bar">
              <div
        ...
        <div className="info-grid">
          <div className="info-column">
                ...
                <span className="info-value">
                  {contract.affiliation_type === 'UNIVERSITY' ? (
                    <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                      <GraduationCap size={14} /> دانشگاه                    </span>
                  ) : (
                    <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
            ...
            <div className="info-section">
              ...
              <div className="info-row">
                ...
                <span className="info-value">{toPersianNumberFn(contract.contract_duration_months || 0)} ماه</span>
              </div>
            </div>
            ...
            <div className="info-section">
              ...
              <div className="info-row">
                ...
                <span className="info-value amount">{toPersianNumberFn(Number(totalAmount))} ریال</span>
              </div>
              <div className="info-row">
                <span className="info-label">مبلغ پرداختی</span>
                <span className="info-value amount success">{toPersianNumberFn(Number(paidAmount))} ریال</span>
              </div>
              <div className="info-row">
                <span className="info-label">مبلغ باقیمانده</span>
                <span className={`info-value amount ${remaining > 0 ? 'warning' : 'success'}`}>
                  {toPersianNumberFn(Number(remaining))} ریال
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="info-column">
            ...
            {/* ✅ فایل‌های پیوست - فقط در صفحه جزئیات نمایش داده می‌شوند */}
            ...
            <div className="info-section meta">
              <div className="meta-row"><span className="meta-label">شناسه</span><span className="meta-value">#{toPersianNumberFn(contract.id)}</span></div>
              <div className="meta-row"><span className="meta-label">نسخه</span><span className="meta-value">{toPersianNumberFn(contract.version)}</span></div>
...
//       let attachmentsText = '';
//       if (contract.attachments && contract.attachments.length > 0) {
//         attachmentsText = contract.attachments.map(att => 
