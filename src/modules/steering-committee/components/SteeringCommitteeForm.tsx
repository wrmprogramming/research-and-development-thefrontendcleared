...
export const SteeringCommitteeForm: React.FC<SteeringCommitteeFormProps> = ({
  ...
  return (
    <div className="steering-committee-form">
      ...
      <style>{`
        .steering-committee-form { padding: 24px; }
        ...
        .form-group input.is-invalid, .form-group textarea.is-invalid { border-color: #dc2626; }
        .error-text { font-size: 12px; color: #dc2626; margin-top: 2px; }
        .jalali-date-rtl { direction: rtl !important; }
        .jalali-date-rtl input { direction: rtl !important; text-align: right !important; }
        ...
        .file-info { display: flex; align-items: center; gap: 8px; padding: 8px 12px; background: #f8fafc; border: 1px solid #e9ecef; border-radius: 6px; flex-wrap: wrap; }
        .file-info.existing { background: #eef2ff; border-color: #c7d2fe; }
        .file-info.removed { background: #fee2e2; border-color: #fecaca; }
        .file-removed-text { font-size: 13px; color: #dc2626; }
        .file-undo { background: none; border: none; color: #4f46e5; cursor: pointer; padding: 2px 4px; border-radius: 4px; transition: all 0.2s; font-size: 16px; }
        .file-undo:hover { background: #eef2ff; }
        ...
        .file-link.download { color: #4f46e5; }
        .file-link.download:hover { background: #e0e7ff; }
        .approvements-section { border-top: 1px solid #e9ecef; padding-top: 16px; }
        ...
        .approvement-item { background: #f8fafc; border: 1px solid #e9ecef; border-radius: 8px; padding: 16px; margin-bottom: 12px; }
        .approvement-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px; }
        .approvement-number { font-size: 13px; font-weight: 600; color: #4f46e5; }
        ...
        .empty-approvements { text-align: center; padding: 20px; color: #6b7280; }
        .empty-approvements p { margin: 0 0 8px 0; }
        ...
        .btn-primary:hover:not(:disabled) { background: #4338ca; box-shadow: 0 4px 12px rgba(79, 70, 229, 0.3); transform: translateY(-1px); }
        ...
        @media (max-width: 768px) {
          .steering-committee-form { padding: 16px; }
          .form-row { grid-template-columns: 1fr; }
          .form-footer { flex-direction: column-reverse; }
          .form-footer button { width: 100%; justify-content: center; }
          .approvement-item { padding: 12px; }
          .approvement-item .form-row { grid-template-columns: 1fr; }
        }
      `}</style>
    </div>
  );
