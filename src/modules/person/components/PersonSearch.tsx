...
export const PersonSelect: React.FC<PersonSelectProps> = ({
  ...
  // ========== لاگ برای دیباگ ==========
  console.log('🔍 PersonSelect - value:', value);
  console.log('🔍 PersonSelect - persons:', persons);
  ...
  console.log('🔍 PersonSelect - selectedPerson:', selectedPerson);
  ...
  // ✅ اصلاح: مقدار id را به درستی برگردان
  const handleSelect = (person: Person) => {
    console.log('✅ PersonSelect - selected person:', person);
    console.log('✅ PersonSelect - selected person id:', person.id);
    
    // اگر همین شخص قبلاً انتخاب شده بود، آن را لغو کن (toggle)
    if (person.id === value) {
      onChange(null);
    } else {
      onChange(person.id);  // ✅ عدد id را برگردان
    }
  ...
  const handleClear = (e: React.MouseEvent) => {
    e.stopPropagation();
    console.log('🗑️ PersonSelect - clear');
    onChange(null);
    setSearchTerm('');
  };
